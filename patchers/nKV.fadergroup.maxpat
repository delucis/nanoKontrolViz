...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 345.0, 43.0, 18.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 255.0, 43.0, 18.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 165.0, 43.0, 18.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 75.0, 135.0, 34.0, 20.0 ],
					"text" : "+ 32"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 195.0, 165.0, 43.0, 18.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 195.0, 259.5, 43.0, 18.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 75.0, 375.0, 59.0, 20.0 ],
					"text" : "ctlin 64 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 75.0, 195.0, 59.0, 20.0 ],
					"text" : "ctlin 32 1"
				}
...
, 			{
				"box" : 				{
					"activebgcolor" : [ 0.356863, 0.388235, 0.423529, 1.0 ],
					"activebgoncolor" : [ 0.94902, 0.376471, 0.0, 1.0 ],
					"id" : "obj-19",
					"ignoreclick" : 1,
					"maxclass" : "live.text",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 195.0, 315.0, 20.0, 140.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 25.0, 45.0, 8.0, 80.0 ],
					"setminmax" : [ 0.0, 127.0 ],
					"setstyle" : 1,
					"settype" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 195.0, 285.0, 53.0, 20.0 ],
					"text" : "ctlin 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 195.0, 195.0, 59.0, 20.0 ],
					"text" : "ctlin 16 1"
				}
...
, 			{
				"box" : 				{
					"activeneedlecolor" : [ 0.353161, 0.3896, 0.42259, 1.0 ],
					"appearance" : 1,
					"dialcolor" : [ 0.568627, 0.619608, 0.662745, 1.0 ],
					"id" : "obj-1",
					"ignoreclick" : 1,
					"maxclass" : "live.dial",
					"numinlets" : 1,
...
,
					"showname" : 0,
					"shownumber" : 0,
					"textcolor" : [ 0.35536, 0.392048, 0.425264, 1.0 ],
					"varname" : "#1-dial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 134.0, 204.5, 120.0, 275.5 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 40.0, 135.0 ],
					"rounded" : 0
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 24.5, 135.0, 60.0, 135.0, 60.0, 120.0, 204.5, 120.0 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 24.5, 135.0, 60.0, 135.0, 60.0, 120.0, 180.0, 120.0, 180.0, 255.0, 204.5, 255.0 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 24.5, 135.0, 72.0, 135.0, 72.0, 132.0, 84.5, 132.0 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 24.5, 222.0, 84.5, 222.0 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 24.5, 312.0, 84.5, 312.0 ],
					"source" : [ "obj-38", 0 ]
				}
